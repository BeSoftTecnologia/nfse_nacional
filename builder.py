"""
Funções para construção de XML no padrão nacional de NFSe.
"""
...
def _map_op_simp_nac(emitter: dict) -> str:
    """
    Mapeia regime tributário para opSimpNac:
...
def build_cancelamento_xml(
    ...
    Args:
        emitter_cnpj: CNPJ do emissor
        chave_acesso_nota: Chave de acesso da nota a ser cancelada
...
def build_nfse_xml(
    ...
    Args:
        emitter: Dicionário com dados do prestador
        client: Dicionário com dados do tomador
        service: Dicionário com dados do serviço
    ...
    if data_emissao:
        try:
            ...
            # Se não tiver timezone, assume timezone local (America/Sao_Paulo)
